...
(function () {
    ...
    var defaultsStrings = {
        ...
        imagedescription: "",
        imagedialog: "<p><b>Example: </b></p><p>http://example.com/images/diagram.jpg \"Optional image description\"</p>",
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions, getString) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.table = makeButton("wmd-table-button", getString("table"), "-200px", bindCommand("doTableRule"));
            makeSpacer(3);
